...
export default function MenuCreatePage() {
  ...
  const coffeeCreateForm = useForm({
    ...
    validate: {
      ...
      des: isNotEmpty("กรุณาระบุชื่อรายละเอียด"),
      price: isNotEmpty("กรุณาระบุรายละเอียดเครื่องดื่ม"),
      available: isNotEmpty("กรุณาเลือกมีส่วนผสมของนม"),
    },
  });
            ...
            <Container className="mt-8">
                ...
                <form onSubmit={coffeeCreateForm.onSubmit(handleSubmit)} className="space-y-8">
                    ...
                    <TextInput
                        ...
                        {...coffeeCreateForm.getInputProps("des")}
                    />
                    ...
                    {/* <Select
                        ...
                        placeholder="ประเภท"
                        data={['ร้อน', 'เย็น', 'ปั่น']}
                        {...coffeeCreateForm.getInputProps("type")}
                            
                    /> */}
                    {/* TODO: เพิ่มรายละเอียดกาแฟ */}
                    ...
                    <Checkbox
                        label="ส่วนผสมของนม"
                        {...coffeeCreateForm.getInputProps("available", {
                            type: "checkbox",
                        })}
                    />
